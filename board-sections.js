...
const FINALJEOPARDYCARD = document.querySelector(".final-jeopardy-card");
...
export {SCOREBOARD, GAMEBOARD, BLOCKS, CLUECARD, /*CLUEBOARD,*/ DAILYDOUBLECARD, FINALJEOPARDYCARD, FINALJEOPARDYBOARD, CATEGORYBLOCKARRAY};
